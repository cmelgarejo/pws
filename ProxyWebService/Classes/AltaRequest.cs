...
namespace ProxyWebService.Classes
{
    public class AltaRequest : BaseProcardRequestClass, IBaseProcardRequestClass
    {
        ...
        public string card_number { get { return _card_number.PadLeft(0, __space); } set { _card_number = value; } }
        public string card_usernumber { get { return _card_usernumber.PadLeft(9, __numberPaddingChar); } set { _card_usernumber = value; } }
        public string card_username { get { return _card_username; } set { _card_username = value; } }
        public string address_street { get { return _address_street; } set { _address_street = value; } }
        public string address_city { get { return _address_city; } set { _address_city = value; } }
        public string address_neighborhood { get { return _address_neighborhood; } set { _address_neighborhood = value; } }
        public string phone_home { get { return _phone_home; } set { _phone_home = value; } }
        public string phone_work { get { return _phone_work; } set { _phone_work = value; } }
        public string phone_mobile { get { return _phone_mobile; } set { _phone_mobile = value; } }
        ...
        public string account_type { get { return _account_type; } set { _account_type = value; } }
        ...
        public string modify_data { get { return _modify_data.PadRight(0, __space); } set { _modify_data = value; } }
        ...
        public string auth_code { get { return _auth_code; } set { _auth_code = value; } }
        public string reject_code { get { return _reject_code; } set { _reject_code = value; } }
        public string reject_motive { get { return _reject_motive; } set { _reject_motive = value; } }
        ...
        public string ProcardMessage()
        {
            return BuildProcardMessage(_change_code, sequence_number, identity_document, entity_code,
                card_class, card_number, card_usernumber, card_username, address_street, address_city, address_neighborhood,
                ...
                card_type, principal_document, modify_data, date, time, auth_code, reject_code, reject_motive, ProcardCredentials);
            //return p;
        }
